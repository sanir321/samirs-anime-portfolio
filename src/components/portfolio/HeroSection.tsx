...
export function HeroSection() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-2 sm:px-8 md:px-16 pt-1 md:pt-16 pb-4 relative overflow-hidden bg-white dark:bg-gray-900" id="home">
